 ...
 * POST /api/auctioneer/register_auctioneer.php
 */
...
if ($auctioneerModel->usernameExists($username)) {
    Response::error('Username already taken', 409);
    exit;
}

if ($auctioneerModel->emailExists($email)) {
...
if ($auctioneerModel->create($name, $username, $email, $passwordHash)) {
